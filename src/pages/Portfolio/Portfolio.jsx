...
export default function Portfolio(){
    ...
    return (
        ...
        <Typography variant="body1">As early as 1998, Amazon realized that they had a problem with contemporary models of application development. They were using a <span style={{color:theme.palette.secondary.main}}>monolithic</span> architecture: one frontend, one backend. But even when they were just selling books, this was just too much for their company to take. Teams were too big, needs were too great, and the entire design was too difficult to maintain. So they developed <span style={{color:theme.palette.secondary.main}}>microservices.</span> Rather than having a single front end relaying data from a single backend, they instead developed multiple apps and had users jump between them while browsing amazon.com.</Typography>
        <Typography variant="body1" sx={{margin:`0 ${theme.spacing(2)}`}}>That means that the "books" section of amazon.com and the "clothing" section are actually completely different applications! They just happen to be hosted at the same URL.</Typography>
