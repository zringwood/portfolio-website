    ...
    return (
        <Box component="article" sx={{  
           ...
           <Typography className="fadein--mediumdelay" sx = {{opacity:`${medium ? 0:1}`}}variant="h4">A casual way to engage with chess.</Typography>
            ...
            <Box component="img"  className="fadein--longdelay"  sx = {{width:"100%", opacity:`${long ? 0:1}`}} src={IntroPuzzle} alt="Basic Chess Puzzle"></Box>
            ...
            <img  className="fadein--longdelay"  style = {{opacity:`${long ? 0:1}`}} src={Snippet} alt="Example function from Tactics DB" />
