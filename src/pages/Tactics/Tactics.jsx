    ...
    return (
        <Box component="article" sx={{  
           ...
           <Typography className="fadein--mediumdelay" sx = {{opacity:`${medium ? 0:1}`}}variant="h4">A casual way to engage with chess.</Typography>
            ...
            <Typography className="fadein--longdelay"  sx = {{opacity:`${long ? 0:1}`}} variant="body1">Can you find the correct move? Click below to reveal the correct move, or try the puzzle on Tactics DB <Link href="https://tactics.zacharyringwood.com/introduction/easy/1" target="_blank" rel="noreferrer">here.</Link></Typography>
            ...
            <Typography className="fadein--longdelay"  sx = {{opacity:`${long ? 0:1}`}} variant="body1">I didn't build the chessboard. That's a third-party library called <Link href="https://github.com/Clariity/react-chessboard" target="_blank" rel="noreferrer">React Chessboard</Link> React Chessboard has some slightly odd qualities I had to work around. For one thing, it interprets every change as a new move and animates the move accordingly. This winds up being a very ugly transition between puzzles. To remove this, the entire board is actually unloaded between puzzles, and an empty board is loaded instead. This leads to a cleaner appearance.</Typography>
            ...
            <Typography className="fadein--longdelay"  sx = {{opacity:`${long ? 0:1}`}} variant="body1">This is code I wrote after reading <Link href="https://www.amazon.ca/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882" target="_blank" rel="noreferrer">Clean Code: A Handbook of Agile Software Craftsmanship</Link> by Robert Martin, aka Uncle Bob. It emphasizes clean, small functions without side effects. I'm very proud of how well the PuzzleBoard component is written, and I encourage you to check it out <Link href="https://github.com/zringwood/tactics-db-gcp/blob/master/src/components/PuzzleBoard/PuzzleBoard.jsx">here, on my GitHub.</Link></Typography>
